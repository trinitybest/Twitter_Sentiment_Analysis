...
if __name__ == "__main__":
    ...
    print('................................................')
    # Read the 3-ways tweets from csv file
    inpTweets = pd.read_csv('sanders-twitter-0.2/full-corpus-3-ways.csv', encoding='ISO-8859-1')
    # Get the tweet words
    tweets = []
    ...
    save_featureList = open("pickled/featureList_3_ways.pickle", "wb")
